...
public class OnTrainDisassemble {
	@SubscribeEvent
	public static void onTrainDisassembly(TrainDisassembleEvent event) {
		...
		player.sendSystemMessage(Component.literal("You have no permission to disassemble this train")
